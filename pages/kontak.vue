  ...
  <div>
    ...
    <div class="gray-container">
      <b-container>
        <b-row>
          <b-col md="12">
            <div class="rounded-wrap px-0 pb-0">
              <b-row>
                <b-col md="12">
                      ...
                      <b-col md="6">
                        <div class="info-ykvi">
                          ...
                          <p>
                            ...
                            <b-link href="mailto:yayasankardiovaskularindonesia@gmail.com">E | yayasankardiovaskularindonesia@gmail.com</b-link><br />
      ...
      meta: [
        {
          hid: "title",
          name: "title",
          content: "Kontak | Yayasan Kardiovaskular Indonesia"
        },
        {
          hid: "og:title",
          name: "og:title",
